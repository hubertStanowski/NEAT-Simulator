...
const NavItems: React.FC<NavItemsProps> = ({
  ...
  return (
    <ul className="nav-ul ml-5">
      <a
        className={`nav-li nav-li_a ${selectedSimulation === "Snake" ? "text-purple-700" : "text-neutral-400"}`}
        onClick={() => {
      ...
      <a
        className={`nav-li nav-li_a ${selectedSimulation === "FlappyBird" ? "text-purple-700" : "text-neutral-400"}`}
        onClick={() => {
          alert(
